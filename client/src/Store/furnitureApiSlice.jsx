...
export const { useGetFurnitureByCategoryQuery, useAddFurnitureMutation, useUpdateFurnitureMutation, useUpdateStockMutation, useDeleteFurnitureMutation } = furnitureApiSlice